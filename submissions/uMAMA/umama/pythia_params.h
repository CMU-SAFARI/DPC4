...
// General parameters
//----------------------------//
static const float alpha = (float)0.006508802942367162;     // NEED TUNING
static const float gamma = (float)0.556300959940946;        // NEED TUNING
static const float epsilon = (float)0.0018228444309622588;  // NEED TUNING
...
static const uint32_t pt_size = 1024;
...
static const int32_t reward_correct_timely = 20;          // NEED TUNING
static const int32_t reward_hbw_correct_timely = 20;      // NEED TUNING
static const int32_t reward_correct_untimely = 12;        // NEED TUNING
static const int32_t reward_hbw_correct_untimely = 12;    // NEED TUNING
static const int32_t reward_incorrect = -8;               // NEED TUNING
static const int32_t reward_hbw_incorrect = -14;          // NEED TUNING
static const int32_t reward_none = -4;                    // NEED TUNING
static const int32_t reward_hbw_none = -2;                // NEED TUNING
static const int32_t reward_out_of_bounds = -12;          // NEED TUNING
static const int32_t reward_hbw_out_of_bounds = -12;      // NEED TUNING

//----------------------------//
// Degree selection logic
//----------------------------//
static const bool enable_dyn_degree = true;
//static const bool enable_dyn_degree = false;
...
static const std::vector<int32_t> le_featurewise_num_tilings = {4, 4};
//static const std::vector<int32_t> le_featurewise_num_tiles = {128, 128};
static const std::vector<int32_t> le_featurewise_num_tiles = {1024, 1024};
